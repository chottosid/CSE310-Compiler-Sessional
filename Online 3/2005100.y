...
;
struct_defintion : STRUCT ID compound_statement
        {
            $$ = new SymbolInfo(getRule({$1,$2,$3}),"struct_definition","",$1->getLineStart(),$3->getLineEnd(),false,{$1,$2,$3});
        }
;
